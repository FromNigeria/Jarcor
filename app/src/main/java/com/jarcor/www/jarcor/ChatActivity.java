...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String userThumb = getIntent().getStringExtra("user_image");
        ...
        if(!userThumb.equals("default")) {
            ...
            Picasso.with(ChatActivity.this).load(userThumb).networkPolicy(NetworkPolicy.OFFLINE)
                ...
                public void onError() {
                    ...
                    Picasso.with(ChatActivity.this).load(userThumb).placeholder(R.drawable.avatar).into(mProfileImage);
                }
            });
