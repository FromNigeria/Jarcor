...
public class FriendsFragment extends Fragment {
            ...
            protected void populateViewHolder(final FriendsViewHolder friendsViewHolder, final Friends friends, int i) {
                ...
                mUsersDatabase.child(list_user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        String userPpa = dataSnapshot.child("ppa_location").getValue().toString();
                        ...
                        if (dataSnapshot.hasChild("online")){
                            ...
                            friendsViewHolder.setUserVerified(userverified);


                        friendsViewHolder.setName(userName);
                        friendsViewHolder.setStatus(userStatus);
                        friendsViewHolder.setPpa(userPpa);
    ...
    public static class FriendsViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setUserVerified(String verified_status){
            ...
            //else do this, set it to INVISIBLE
            else{
